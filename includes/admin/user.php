...
function cbs_add_contributor_cap() {
...
function cbs_add_profile_fields( $user ) {
	...
	<table class="form-table subscriptions-table">
		<tr>
			<th><?php _e( 'Subscription (automatic renewal)', 'course-booking-system' ); ?></th>
			<td>
				<label for="abo"><input type="checkbox" name="abo" id="abo" value="1" <?= get_user_meta( $user->ID, 'abo', true ) ? 'checked="checked"' : '' ?> /><?php _e( 'Yes', 'woocommerce' ); ?></label>
			</td>
		</tr>
		<tr>
			<th><?php _e( '2. Subscription (automatic renewal)', 'course-booking-system' ); ?></th>
			<td>
				<label for="abo_2">
				<?php if ( $is_licensed ) : ?>
					<input type="checkbox" name="abo_2" id="abo_2" value="1" <?= get_user_meta( $user->ID, 'abo_2', true ) ? 'checked="checked"' : '' ?> /><?php _e( 'Yes', 'woocommerce' ); ?>
				<?php else : ?>
					<input type="checkbox" name="abo_2" id="abo_2" value="1" <?= get_user_meta( $user->ID, 'abo_2', true ) ? 'checked="checked"' : '' ?> disabled /><?php _e( 'Yes', 'woocommerce' ); ?> <?php printf( __( '<a href="%s" target="_blank">Pro Feature</a>', 'course-booking-system' ), 'https://commotion.online/en/shop/course-booking-system-pro-license/' ); ?>
				<?php endif; ?>
				</label>
			</td>
		</tr>
		<tr>
			<th><?php _e( '3. Subscription (automatic renewal)', 'course-booking-system' ); ?></th>
			<td>
				<label for="abo_3">
				<?php if ( $is_licensed ) : ?>
					<input type="checkbox" name="abo_3" id="abo_3" value="1" <?= get_user_meta( $user->ID, 'abo_3', true ) ? 'checked="checked"' : '' ?> /><?php _e( 'Yes', 'woocommerce' ); ?>
				<?php else : ?>
					<input type="checkbox" name="abo_3" id="abo_3" value="1" <?= get_user_meta( $user->ID, 'abo_3', true ) ? 'checked="checked"' : '' ?> disabled /><?php _e( 'Yes', 'woocommerce' ); ?> <?php printf( __( '<a href="%s" target="_blank">Pro Feature</a>', 'course-booking-system' ), 'https://commotion.online/en/shop/course-booking-system-pro-license/' ); ?>
				<?php endif; ?>
				</label>
			</td>
		</tr>
		<tr>
			<th><?php _e( 'More Subscriptions (up to 10)', 'course-booking-system' ); ?></th>
			<td>
				<label for="abo_10">
				<?php if ( $is_licensed ) : ?>
					<input type="checkbox" name="abo_10" id="abo_10" value="1" <?= get_user_meta( $user->ID, 'abo_10', true ) ? 'checked="checked"' : '' ?> /><?php _e( 'Yes', 'woocommerce' ); ?>
				<?php else : ?>
					<input type="checkbox" name="abo_10" id="abo_10" value="1" <?= get_user_meta( $user->ID, 'abo_10', true ) ? 'checked="checked"' : '' ?> disabled /><?php _e( 'Yes', 'woocommerce' ); ?> <?php printf( __( '<a href="%s" target="_blank">Pro Feature</a>', 'course-booking-system' ), 'https://commotion.online/en/shop/course-booking-system-pro-license/' ); ?>
				<?php endif; ?>
				</label>
			</td>
		</tr>
			...
			<td>
				<select name="abo_course" id="abo_course">
					...
					<?php foreach ( $courses as $course ) { ?>
						...
						<option value="<?= $course->id ?>" <?= get_user_meta( $user->ID, 'abo_course', true ) == $course->id ? 'selected="selected"' : '' ?>><?= $course->post_title ?>, <?= cbs_get_weekday( $course->day ) ?>, <?= cbs_get_time_formatted( $course->start, $course->end ) ?>, <?= $user_info->display_name ?></option>
					<?php } ?>
				</select>
			</td>
		</tr>
		<tr id="tr-abo_course_2" <?= get_user_meta( $user->ID, 'abo_2', true ) || ( !empty( get_user_meta($user->ID, 'abo_course_2', true) ) && get_the_author_meta( 'abo_expire', $user->ID ) ) ? 'style="display: table-row;"' : 'style="display: none;"' ?>>
			...
			<td>
				<select name="abo_course_2" id="abo_course_2">
					...
					<?php foreach ( $courses as $course ) { ?>
						<?php $user_info = get_userdata( $course->user_id ); ?>
						<option value="<?= $course->id ?>" <?= (get_user_meta($user->ID, 'abo_course_2', true) == $course->id) ? 'selected="selected"' : '' ?>><?= $course->post_title ?>, <?= cbs_get_weekday( $course->day ) ?>, <?= cbs_get_time_formatted( $course->start, $course->end ) ?>, <?= $user_info->display_name ?></option>
					<?php } ?>
				</select>
			</td>
		</tr>
		<tr id="tr-abo_course_3" <?= get_user_meta( $user->ID, 'abo_3', true ) ? 'style="display: table-row;"' : 'style="display: none;"' ?>>
			...
			<td>
				<select name="abo_course_3" id="abo_course_3">
					...
					<?php foreach ( $courses as $course ) { ?>
						<?php $user_info = get_userdata( $course->user_id ); ?>
						<option value="<?= $course->id ?>" <?= (get_user_meta($user->ID, 'abo_course_3', true) == $course->id) ? 'selected="selected"' : '' ?>><?= $course->post_title ?>, <?= cbs_get_weekday( $course->day ) ?>, <?= cbs_get_time_formatted( $course->start, $course->end ) ?>, <?= $user_info->display_name ?></option>
					<?php } ?>
				</select>
			</td>
		</tr>
		<tr class="tr-abo_course_10" <?= get_user_meta( $user->ID, 'abo_10', true ) ? 'style="display: table-row;"' : 'style="display: none;"' ?>>
				<th><label for="abo_course_4">4. <?php _e( 'Subscription course', 'course-booking-system' ); ?></label></th>
				<td>
					<select name="abo_course_4" id="abo_course_4">
						<option value=""><?php _e( 'Choose a course', 'course-booking-system' ); ?></option>
						<?php foreach ( $courses as $course ) { ?>
							<?php $user_info = get_userdata( $course->user_id ); ?>
							<option value="<?= $course->id ?>" <?= (get_user_meta($user->ID, 'abo_course_4', true) == $course->id) ? 'selected="selected"' : '' ?>><?= $course->post_title ?>, <?= cbs_get_weekday( $course->day ) ?>, <?= cbs_get_time_formatted( $course->start, $course->end ) ?>, <?= $user_info->display_name ?></option>
						<?php } ?>
					</select>
				</td>
		</tr>
		<tr class="tr-abo_course_10" <?= get_user_meta( $user->ID, 'abo_10', true ) ? 'style="display: table-row;"' : 'style="display: none;"' ?>>
			<th><label for="abo_course_4">5. <?php _e( 'Subscription course', 'course-booking-system' ); ?></label></th>
			<td>
				<select name="abo_course_4" id="abo_course_4">
					<option value=""><?php _e( 'Choose a course', 'course-booking-system' ); ?></option>
					<?php foreach ( $courses as $course ) { ?>
		...
		<tr class="tr-abo_course_10" <?= get_user_meta( $user->ID, 'abo_10', true ) ? 'style="display: table-row;"' : 'style="display: none;"' ?>>
			<th><label for="abo_course_5">6. <?php _e( 'Subscription course', 'course-booking-system' ); ?></label></th>
			<td>
				<select name="abo_course_5" id="abo_course_5">
					<option value=""><?php _e( 'Choose a course', 'course-booking-system' ); ?></option>
					<?php foreach ( $courses as $course ) { ?>
						<?php $user_info = get_userdata( $course->user_id ); ?>
						<option value="<?= $course->id ?>" <?= (get_user_meta($user->ID, 'abo_course_5', true) == $course->id) ? 'selected="selected"' : '' ?>><?= $course->post_title ?>, <?= cbs_get_weekday( $course->day ) ?>, <?= cbs_get_time_formatted( $course->start, $course->end ) ?>, <?= $user_info->display_name ?></option>
					<?php } ?>
				</select>
			</td>
		</tr>
		<tr class="tr-abo_course_10" <?= get_user_meta( $user->ID, 'abo_10', true ) ? 'style="display: table-row;"' : 'style="display: none;"' ?>>
			<th><label for="abo_course_7">7. <?php _e( 'Subscription course', 'course-booking-system' ); ?></label></th>
			<td>
				<select name="abo_course_7" id="abo_course_7">
					<option value=""><?php _e( 'Choose a course', 'course-booking-system' ); ?></option>
					<?php foreach ( $courses as $course ) { ?>
						<?php $user_info = get_userdata( $course->user_id ); ?>
						<option value="<?= $course->id ?>" <?= (get_user_meta($user->ID, 'abo_course_7', true) == $course->id) ? 'selected="selected"' : '' ?>><?= $course->post_title ?>, <?= cbs_get_weekday( $course->day ) ?>, <?= cbs_get_time_formatted( $course->start, $course->end ) ?>, <?= $user_info->display_name ?></option>
					<?php } ?>
				</select>
			</td>
		</tr>
		<tr class="tr-abo_course_10" <?= get_user_meta( $user->ID, 'abo_10', true ) ? 'style="display: table-row;"' : 'style="display: none;"' ?>>
			<th><label for="abo_course_8">8. <?php _e( 'Subscription course', 'course-booking-system' ); ?></label></th>
			<td>
				<select name="abo_course_8" id="abo_course_8">
					<option value=""><?php _e( 'Choose a course', 'course-booking-system' ); ?></option>
					<?php foreach ( $courses as $course ) { ?>
						<?php $user_info = get_userdata( $course->user_id ); ?>
						<option value="<?= $course->id ?>" <?= (get_user_meta($user->ID, 'abo_course_8', true) == $course->id) ? 'selected="selected"' : '' ?>><?= $course->post_title ?>, <?= cbs_get_weekday( $course->day ) ?>, <?= cbs_get_time_formatted( $course->start, $course->end ) ?>, <?= $user_info->display_name ?></option>
					<?php } ?>
				</select>
			</td>
		</tr>
		<tr class="tr-abo_course_10" <?= get_user_meta( $user->ID, 'abo_10', true ) ? 'style="display: table-row;"' : 'style="display: none;"' ?>>
			<th><label for="abo_course_9">9. <?php _e( 'Subscription course', 'course-booking-system' ); ?></label></th>
			<td>
				<select name="abo_course_9" id="abo_course_9">
					<option value=""><?php _e( 'Choose a course', 'course-booking-system' ); ?></option>
					<?php foreach ( $courses as $course ) { ?>
						<?php $user_info = get_userdata( $course->user_id ); ?>
						<option value="<?= $course->id ?>" <?= (get_user_meta($user->ID, 'abo_course_9', true) == $course->id) ? 'selected="selected"' : '' ?>><?= $course->post_title ?>, <?= cbs_get_weekday( $course->day ) ?>, <?= cbs_get_time_formatted( $course->start, $course->end ) ?>, <?= $user_info->display_name ?></option>
					<?php } ?>
				</select>
			</td>
		</tr>
		<tr class="tr-abo_course_10" <?= get_user_meta( $user->ID, 'abo_10', true ) ? 'style="display: table-row;"' : 'style="display: none;"' ?>>
			<th><label for="abo_course_10">10. <?php _e( 'Subscription course', 'course-booking-system' ); ?></label></th>
			<td>
				<select name="abo_course_10" id="abo_course_10">
					<option value=""><?php _e( 'Choose a course', 'course-booking-system' ); ?></option>
					<?php foreach ( $courses as $course ) { ?>
						<?php $user_info = get_userdata( $course->user_id ); ?>
						<option value="<?= $course->id ?>" <?= (get_user_meta($user->ID, 'abo_course_10', true) == $course->id) ? 'selected="selected"' : '' ?>><?= $course->post_title ?>, <?= cbs_get_weekday( $course->day ) ?>, <?= cbs_get_time_formatted( $course->start, $course->end ) ?>, <?= $user_info->display_name ?></option>
					<?php } ?>
				</select>
			</td>
		</tr>
	...
	<table class="form-table flatrates-table">
		<tr>
			<th><?php _e( 'Flatrate', 'course-booking-system' ); ?> (<?= $price_level_title ?>)</th>
			<td>
				<label for="flat"><input type="checkbox" name="flat" id="flat" value="1" <?= get_user_meta($user->ID, 'flat', true) ? 'checked="checked"' : '' ?> /><?php _e( 'Yes', 'woocommerce' ); ?></label>
			</td>
		</tr>
		...
		<tr>
			<th>2. <?php _e( 'Flatrate', 'course-booking-system' ); ?> (<?= $price_level_title_2 ?>)</th>
			<td>
				<label for="flat_2">
				<?php if ( $is_licensed ) : ?>
					<input type="checkbox" name="flat_2" id="flat_2" value="1" <?= get_user_meta($user->ID, 'flat_2', true) ? 'checked="checked"' : '' ?> /><?php _e( 'Yes', 'woocommerce' ); ?>
				<?php else : ?>
					<input type="checkbox" name="flat_2" id="flat_2" value="1" <?= get_user_meta($user->ID, 'flat_2', true) ? 'checked="checked"' : '' ?> disabled /><?php _e( 'Yes', 'woocommerce' ); ?> <?php printf( __( '<a href="%s" target="_blank">Pro Feature</a>', 'course-booking-system' ), 'https://commotion.online/en/shop/course-booking-system-pro-license/' ); ?>
				<?php endif; ?>
				</label>
			</td>
		</tr>
		...
		<tr>
			<th>3. <?php _e( 'Flatrate', 'course-booking-system' ); ?> (<?= $price_level_title_3 ?>)</th>
			<td>
				<label for="flat_3">
				<?php if ( $is_licensed ) : ?>
					<input type="checkbox" name="flat_3" id="flat_3" value="1" <?= get_user_meta($user->ID, 'flat_3', true) ? 'checked="checked"' : '' ?> /><?php _e( 'Yes', 'woocommerce' ); ?>
				<?php else : ?>
					<input type="checkbox" name="flat_3" id="flat_3" value="1" <?= get_user_meta($user->ID, 'flat_3', true) ? 'checked="checked"' : '' ?> disabled /><?php _e( 'Yes', 'woocommerce' ); ?> <?php printf( __( '<a href="%s" target="_blank">Pro Feature</a>', 'course-booking-system' ), 'https://commotion.online/en/shop/course-booking-system-pro-license/' ); ?>
				<?php endif; ?>
				</label>
			</td>
		</tr>
		...
		<tr>
			<th>4. <?php _e( 'Flatrate', 'course-booking-system' ); ?> (<?= $price_level_title_4 ?>)</th>
			<td>
				<label for="flat_4">
				<?php if ( $is_licensed ) : ?>
					<input type="checkbox" name="flat_4" id="flat_4" value="1" <?= get_user_meta($user->ID, 'flat_4', true) ? 'checked="checked"' : '' ?> /><?php _e( 'Yes', 'woocommerce' ); ?>
				<?php else : ?>
					<input type="checkbox" name="flat_4" id="flat_4" value="1" <?= get_user_meta($user->ID, 'flat_4', true) ? 'checked="checked"' : '' ?> disabled /><?php _e( 'Yes', 'woocommerce' ); ?> <?php printf( __( '<a href="%s" target="_blank">Pro Feature</a>', 'course-booking-system' ), 'https://commotion.online/en/shop/course-booking-system-pro-license/' ); ?>
				<?php endif; ?>
				</label>
			</td>
		</tr>
		...
		<tr>
			<th>5. <?php _e( 'Flatrate', 'course-booking-system' ); ?> (<?= $price_level_title_5 ?>)</th>
			<td>
				<label for="flat_5">
				<?php if ( $is_licensed ) : ?>
					<input type="checkbox" name="flat_5" id="flat_5" value="1" <?= get_user_meta($user->ID, 'flat_5', true) ? 'checked="checked"' : '' ?> /><?php _e( 'Yes', 'woocommerce' ); ?>
				<?php else : ?>
					<input type="checkbox" name="flat_5" id="flat_5" value="1" <?= get_user_meta($user->ID, 'flat_5', true) ? 'checked="checked"' : '' ?> disabled /><?php _e( 'Yes', 'woocommerce' ); ?> <?php printf( __( '<a href="%s" target="_blank">Pro Feature</a>', 'course-booking-system' ), 'https://commotion.online/en/shop/course-booking-system-pro-license/' ); ?>
				<?php endif; ?>
				</label>
			</td>
		</tr>
			...
			<tbody>
				...
				foreach ( $bookings as $booking ) {
					...
					foreach ( $courses as $course ) {
						echo '<tr id="booking-id-'.$booking_id.'"><td><a href="'.get_edit_post_link( $course->post_id ).'">'.$course->post_title.'</a></td><td>';

						if ( $course->day != 99 )
							echo cbs_get_weekday( $course->day ).', ';

						echo date_i18n( $date_format, strtotime( $date ) ).'</td><td>'.cbs_get_time_formatted( $course->start, $course->end ).'</td><td><a href="#" class="button btn btn-primary et_pb_button action-booking-delete" title="'.__( 'Reverse', 'course-booking-system' ).'" data-id="'.$course_id.'" data-date="'.$date.'" data-user="'.$user_id.'" data-booking="'.$booking_id.'">×</a></td></tr>';
					}
				}
				?>
			</tbody>
		...
		<table class="bookings-past-table">
			<tbody>
				...
				foreach ( $bookings as $booking ) {
					...
					$courses = $wpdb->get_results( "SELECT post_title, day, post_id, start, end FROM ".$wpdb->prefix."posts JOIN ".$wpdb->prefix."cbs_data ON ".$wpdb->prefix."posts.ID = ".$wpdb->prefix."cbs_data.post_id WHERE ".$wpdb->prefix."cbs_data.id = $course_id LIMIT 1" );
					foreach ( $courses as $course ) {
						echo '<tr><td><a href="'.get_edit_post_link( $course->post_id ).'">'.$course->post_title.'</a></td><td>';

						if ( $course->day != 99 )
							echo cbs_get_weekday( $course->day ).', ';

						echo date_i18n( $date_format, strtotime( $date ) ).'</td><td>'.cbs_get_time_formatted( $course->start, $course->end ).'</td></tr>';
					}
				}
				?>
			</tbody>
	...
	$cancellations = $wpdb->get_results( "SELECT * FROM ".$wpdb->prefix."cbs_cancellations WHERE user_id = $user->ID ORDER BY timestamp DESC LIMIT 10" );
	if ( count( $cancellations ) > 0 ) { ?>
		<h2 class="cancellations-headline"><?php _e( 'Cancellations', 'course-booking-system' ); ?></h4>
		<table class="cancellations-table">
			<tbody>
				...
				foreach ( $cancellations as $cancellation ) {
					$course_id = $cancellation->course_id;
					...
					foreach ( $courses as $course )
						echo '<tr><td><a href="'.get_edit_post_link( $course->post_id ).'">'.$course->post_title.'</a></td><td>'.cbs_get_weekday( $course->day ).', '.date_i18n( $date_format, strtotime( $date ) ).'</td><td>'.cbs_get_time_formatted( $course->start, $course->end ).'</td><td>'.date_i18n( $date_format.' '.$time_format, strtotime( $timestamp ) ).'</td></tr>';
				}
				?>
			</tbody>
		</table>
...
function cbs_save_profile_fields( $user_id ) {
	...
	if ( isset( $_POST['abo_course_4'] ) )
		update_user_meta( $user_id, 'abo_course_4', sanitize_text_field( $_POST['abo_course_4'] ) );

	if ( isset( $_POST['abo_course_5'] ) )
		update_user_meta( $user_id, 'abo_course_5', sanitize_text_field( $_POST['abo_course_5'] ) );

	if ( isset( $_POST['abo_course_6'] ) )
		update_user_meta( $user_id, 'abo_course_6', sanitize_text_field( $_POST['abo_course_6'] ) );

	if ( isset( $_POST['abo_course_7'] ) )
		update_user_meta( $user_id, 'abo_course_7', sanitize_text_field( $_POST['abo_course_7'] ) );

	if ( isset( $_POST['abo_course_8'] ) )
		update_user_meta( $user_id, 'abo_course_8', sanitize_text_field( $_POST['abo_course_8'] ) );

	if ( isset( $_POST['abo_course_9'] ) )
		update_user_meta( $user_id, 'abo_course_9', sanitize_text_field( $_POST['abo_course_9'] ) );

	if ( isset( $_POST['abo_course_10'] ) )
		update_user_meta( $user_id, 'abo_course_10', sanitize_text_field( $_POST['abo_course_10'] ) );
